...
import pandas as pd
INPUT_SCAN_FOLDER='E:\\PROIECT2\\NEU surface defect database\\' # locatia unde se gaseste baza de date
...
filepath="E:\\PROIECT2\\"+"features.xlsx"  #locatia unde se salveaza fisierul cu proprietatile
